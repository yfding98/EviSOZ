...
> Evidence JSON 的逐字段运行时地图、真实实例路径和可复核命令见 [`evisoz_evidence_json_runtime_usage_v1_20260901_zh.md`](evisoz_evidence_json_runtime_usage_v1_20260901_zh.md)。该附录以当前 Stage-0 工件为准，不把设计态富结构示例误写成已落盘或已授权结构。
...
```text
labram_portable_equal_ensemble_protocol_v29_20260815_zh.md
