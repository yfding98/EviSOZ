...
# Supply independently recorded manifest hashes for the six already-published
# v1.2 producers.  This launcher has no SOZ/private/source-eval target input.
...
OUTPUT_DIRECTORY="${7:-outputs/labram_k31_development_scores_v1_2_20260810}"

rtk python3 scripts/materialize_labram_k31_development_scores_v1_2.py \
  --recovery-run "fold0=outputs/labram_ictal_k31_oof_recovery_v1_2_20260810/fold0=$1" \
  --recovery-run "fold1=outputs/labram_ictal_k31_oof_recovery_v1_2_20260810/fold1=$2" \
  --recovery-run "fold2=outputs/labram_ictal_k31_oof_recovery_v1_2_20260810/fold2=$3" \
  --recovery-run "fold3=outputs/labram_ictal_k31_oof_recovery_v1_2_20260810/fold3=$4" \
  --recovery-run "fold4=outputs/labram_ictal_k31_oof_recovery_v1_2_20260810/fold4=$5" \
  --recovery-run "final=outputs/labram_ictal_k31_oof_recovery_v1_2_20260810/final=$6" \
