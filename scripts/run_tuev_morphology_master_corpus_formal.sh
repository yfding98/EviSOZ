...
# Materialize the one authorization-bound TUEV morphology master corpus.
# Every cohort, signal, preprocessing, and foundation input is pinned here;
# this wrapper intentionally exposes no labels, group rosters, arm choice,
# token tensors, microbatch size, or other training knobs.

rtk python3 scripts/materialize_tuev_morphology_master_corpus.py \
  ...
  --device cuda \
  --output-directory outputs/tuev_morphology_master_corpus_formal_v1_20260809
