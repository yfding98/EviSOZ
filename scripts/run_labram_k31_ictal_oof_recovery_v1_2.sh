...
# Target-free v1.2 recovery.  This command intentionally has no DeepSOZ source
# CSV argument and writes to a root that cannot mix with v1.1 bundles.
if [[ $# -lt 1 || $# -gt 2 ]]; then
  echo "usage: $0 {fold0|fold1|fold2|fold3|fold4|final} [--preflight-only]" >&2
  exit 2
fi
SELECTION="$1"
PREFLIGHT=()
if [[ $# -eq 2 ]]; then
  [[ "$2" == "--preflight-only" ]] || { echo "second argument must be --preflight-only" >&2; exit 2; }
  PREFLIGHT=(--preflight-only)
fi
case "$SELECTION" in
  fold0) FOLD_DIRECTORY="fold_0"; TRAINING_MANIFEST_BUNDLE="outputs/tusz_ictal_oof_fold_manifests_v4_1_20260809_current_preflight/fold_0"; TRAINING_BUNDLE_SHA256="88857946163e6583795079810d65d078d0d3c325a7dfe1bca86fe29c68e78200"; TRAINING_SOURCE_SHA256="0cd023bcee1d58dd7e254427837dc0a942b2310a31882134b80d61469ec6510a"; TRAINING_TOKEN_SHA256="fae930dbbaed5e80af12723909110ab05b3ab7ce86562aa357aa78e8bbbd59b1" ;;
  fold1) FOLD_DIRECTORY="fold_1"; TRAINING_MANIFEST_BUNDLE="outputs/tusz_ictal_oof_fold_manifests_v4_1_20260809_current_preflight/fold_1"; TRAINING_BUNDLE_SHA256="f03cb001fcfe32ccb05a646813a6941014212f71f8bc6e11a887c852e3f585c7"; TRAINING_SOURCE_SHA256="b86a7d982fc1e060cd0dea9086f6adac6a4f3ea9874ca4d1c6206da960e9ac7f"; TRAINING_TOKEN_SHA256="bb130ae50e857798a80be2cd551565251db85d6fb3ba95a8ba5c0eb49033de72" ;;
  fold2) FOLD_DIRECTORY="fold_2"; TRAINING_MANIFEST_BUNDLE="outputs/tusz_ictal_oof_fold_manifests_v4_1_20260809_current_preflight/fold_2"; TRAINING_BUNDLE_SHA256="15365ee222f2ef041e8ba54266a82208d7798f425a860a04e61b560cf01678ca"; TRAINING_SOURCE_SHA256="a0712976693e64dba17b09538f064f2b7197d3464447c90b5ef450a800775b6b"; TRAINING_TOKEN_SHA256="f52fc4d9d5f88ca6cd94d358a1ad385d955ac1d3c2b83b27f9ba677a890aab52" ;;
  fold3) FOLD_DIRECTORY="fold_3"; TRAINING_MANIFEST_BUNDLE="outputs/tusz_ictal_oof_fold_manifests_v4_1_20260809_current_preflight/fold_3"; TRAINING_BUNDLE_SHA256="d0b158c80c76f5302ce47e8074b5901bf81e646855493be7760657c70f49bbb4"; TRAINING_SOURCE_SHA256="06af3bec1714c93a110ca7bcdcd83aeac6cb2940492ed442e58f82e836704094"; TRAINING_TOKEN_SHA256="39ae5bd86a21bec577e01ebd8d68bf6d31b783b1d3ed1ac1a0f98b26601c701f" ;;
  fold4) FOLD_DIRECTORY="fold_4"; TRAINING_MANIFEST_BUNDLE="outputs/tusz_ictal_oof_fold_manifests_v4_1_20260809_current_preflight/fold_4"; TRAINING_BUNDLE_SHA256="81eb77a10479778a149fbf02546c039b4141a242a24e93eaf0d46af7ec5e7381"; TRAINING_SOURCE_SHA256="d4de03763212278463da6a67373b0af6f084e9abc1c67b91e41c7ab7787923d9"; TRAINING_TOKEN_SHA256="431b13e959384da011ac7b2353836c74d8b1a3c3e41556871fa3bb4983c40fcf" ;;
  final) FOLD_DIRECTORY="master"; TRAINING_MANIFEST_BUNDLE="outputs/tusz_ictal_master_manifest_v4_1_20260809_current_preflight"; TRAINING_BUNDLE_SHA256="73e821d08805c3a7e8ae75011dd98fe10c388d7291c74881286438e91cacc35f"; TRAINING_SOURCE_SHA256="d5329b9231ecea7aaae6e126f5cd7a17a51f21b950025b32369592379acf8cb8"; TRAINING_TOKEN_SHA256="a7d672e3228cdc71fafb46e910033f6a5302a9e2e0a5f5716f7f4c8292ecfc26" ;;
  *) echo "selection must be fold0..fold4 or final" >&2; exit 2 ;;
esac
COMMON_ARGS=(
  --selection "$SELECTION"
  ...
  --v5-split outputs/tusz_ictal_formal_v5_auxiliary_split_20260810/split.json
  --expected-v5-split-sha256 cdcf56c1d1931ad22d18a0d91b4c5506edd8adb726c1f043cb2c701294a8bc21
  --formal-v4-target-snapshot outputs/tusz_ictal_prediction_artifacts_formal_v4_20260809/final/native
  --expected-formal-v4-target-snapshot-manifest-sha256 bc22681928e596ef6564af51f54215e96a9560a21cdeaedef043ccd324596cba
  --expected-formal-v4-target-snapshot-receipt-sha256 e216338d5112a67d20fcba5d545834af2b84c8896a8713b9919866e839c7953a
  ...
  --output-directory "outputs/labram_ictal_k31_oof_recovery_v1_2_20260810/$SELECTION"
  --device cuda
)
rtk mkdir -p outputs/labram_ictal_k31_oof_recovery_v1_2_20260810
if [[ "$SELECTION" == "final" ]]; then
  rtk python3 scripts/train_labram_k31_ictal_oof_recovery_v1_2.py "${COMMON_ARGS[@]}" \
    ...
    --expected-native-evaluation-signal-preflight-receipt-sha256 10128ad30d2163838222d0b4a27d9889a767276a9b697812e3cf568a3d9fd446 "${PREFLIGHT[@]}"
else
  rtk python3 scripts/train_labram_k31_ictal_oof_recovery_v1_2.py "${COMMON_ARGS[@]}" \
    ...
    --expected-native-evaluation-token-corpus-index-sha256 a7d672e3228cdc71fafb46e910033f6a5302a9e2e0a5f5716f7f4c8292ecfc26 "${PREFLIGHT[@]}"
fi
